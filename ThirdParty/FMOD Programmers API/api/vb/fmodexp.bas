...
Public Const FMOD_VERSION As Long = &H42804
...
Public Declare Function FMOD_System_GetCPUUsage Lib "fmodexp.dll" (ByVal system As Long, ByRef Dsp As Single, ByRef Stream As Single, ByRef Geometry As Single, ByRef Update As Single, ByRef total As Single) As FMOD_RESULT
