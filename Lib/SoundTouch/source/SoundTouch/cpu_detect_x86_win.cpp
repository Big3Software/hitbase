...
//JUS! static uint _dwDisabledISA = 0x00;      // 0xffffffff; //<- use this to disable all extensions


// Disables given set of instruction extensions. See SUPPORT_... defines.
void disableExtensions(uint dwDisableMask)
{
    // JUS _dwDisabledISA = dwDisableMask;
}
...
uint detectCPUextensions(void)
{
    ...
    // JUS if (_dwDisabledISA == 0xffffffff) return 0;
