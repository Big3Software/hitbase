...
{
    public class VirtualizingAlbumPanel : VirtualizingPanel, IScrollInfo
    {
        List<double> itemsTopPosition = new List<double>();
        List<double> itemsHeight = new List<double>();
        double totalHeight = 0;

        public VirtualizingAlbumPanel()
        {
        ...
        {
            double maxHeight = 1000000;     // Höhe sollte eigentlich unbegrenzt sein
