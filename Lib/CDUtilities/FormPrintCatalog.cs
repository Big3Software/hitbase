...
//                        SizeF size = e.Graphics.MeasureString(value, Settings.Current.PrintDetailsFont);
        ...
        private void UpdateWindowState()
        {
            ...
            buttonSelectFields.Enabled = printType == PrintType.CDList || printType == PrintType.DetailList || printType == PrintType.DetailListWithTracks || printType == PrintType.TrackList;
            buttonFilter.Enabled = printType == PrintType.CDList || printType == PrintType.DetailList || printType == PrintType.DetailListWithTracks || printType == PrintType.TrackList;
            buttonSort.Enabled = printType == PrintType.CDList || printType == PrintType.DetailList || printType == PrintType.DetailListWithTracks || printType == PrintType.TrackList;
        }
