...
namespace Big3.Hitbase.Controls
{
	...
	public class TreeListView : ContainerListView
	{
		...
		public TreeListView(): base()
		{
			...
			//Assembly myAssembly = Assembly.GetAssembly(Type.GetType("Big3.Hitbase.Controls.TreeListView"));
            //Stream bitmapStream1 = myAssembly.GetManifestResourceStream("Big3.Hitbase.Controls.Resources.tv_minus.bmp");
            bmpMinus = Images.tv_minus;// new Bitmap(bitmapStream1);

            //Stream bitmapStream2 = myAssembly.GetManifestResourceStream("Big3.Hitbase.Controls.Resources.tv_plus.bmp");
            bmpPlus = Images.tv_plus;// new Bitmap(bitmapStream2);
		}
		#endregion
