...
namespace Big3.Hitbase.Controls
{
    ...
    public class PromptedTextBox : System.Windows.Forms.TextBox
    {
        ...
        {
            // Nicht mehr benutzen! Kann bald gelöscht werden.
            throw new Exception("NICHT MEHR BENUTZEN! Statt dessen CueBannerTextBox!");
        ...
        protected virtual void DrawTextPrompt(Graphics g)
        {
            ...
            g.DrawImageUnscaled(Images.SearchSmall, rect.Right - 20, rect.Top);
        }
    }
}
