...
public:
	...
	static CString PrintMD5(uchar md5Digest[16]);
	static CString MD5String(char* szString);
	static CString MD5File(const CString& szFilename);
