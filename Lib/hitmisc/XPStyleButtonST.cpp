...
LRESULT CXPStyleButtonST::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	if (message == 0x128/*WM_UPDATEUISTATE*/)
		Invalidate(FALSE);

	return CButtonST::WindowProc(message, wParam, lParam);
}
