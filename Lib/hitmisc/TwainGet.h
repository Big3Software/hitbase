...
typedef void (CALLBACK* TWAINCALLBACKPROC)(CPicture* pPicture, LPARAM lParam);
...
//#define CALLBACK_COPYIMAGE static void CALLBACK 

class HITMISC_INTERFACE CTwain
{
public:
	...
	*/
	...
	BOOL Acquire(int numImages=1, TWAINCALLBACKPROC TwainCallbackProc = NULL, LPARAM lParam = 0);
	HWND m_hMessageWnd;
...
protected:
	...
	int m_nImageCount;
	int m_nTransferedImages;

	TWAINCALLBACKPROC m_pTwainCallbackProc;
	LPARAM m_lParam;
};
