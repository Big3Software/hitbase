...
namespace Big3.Hitbase.DataBaseEngine.ProgramDataSetTableAdapters {
    ...
    public partial class ProgramTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT [CDID], [Name], [Tracks], [IsStandard] FROM [Program] WHERE [CDID]=?";
        ...
        public virtual int Fill(ProgramDataSet.ProgramDataTable dataTable) {
        ...
        public virtual ProgramDataSet.ProgramDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProgramDataSet.ProgramDataTable dataTable = new ProgramDataSet.ProgramDataTable();
        ...
        public virtual int FillByCdId(ProgramDataSet.ProgramDataTable dataTable, global::System.Nullable<int> Param1) {
        ...
        public virtual ProgramDataSet.ProgramDataTable GetDataByCdId(global::System.Nullable<int> Param1) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Param1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Param1.Value));
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProgramDataSet.ProgramDataTable dataTable) {
